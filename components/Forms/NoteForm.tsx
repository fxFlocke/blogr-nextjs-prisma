                                                ...
                                                <div className="bg-white p-4 text-sm text-gray-500">
                                                    <div className="grid gap-2 mb-6 grid-cols-1">
                                                        ...
                                                        <div>
                                                            ...
                                                            <textarea id="trackedPerson" value={content} onInput={(e: React.ChangeEvent<HTMLTextAreaElement>) => setContent(e.target.value)} maxLength={50} className="h-[105px] bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required/>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
